                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            ...
                            <AlertDialogDescription> 
                                This action cannot be undone. This will permanently delete the <span className='font-bold'>{collection.name}</span> collection, and remove all tasks associated with it.
                            </AlertDialogDescription>
                            <AlertDialogFooter>
                                <AlertDialogCancel>
                                    Cancel
